          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div className="flex items-center space-x-3 text-blue-600">
                ...
                <span className="text-sm font-semibold uppercase tracking-wider">Doctor Portal</span>
              </div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-xl">
                Access your AI-powered medical dashboard to manage patients, view analytics, and deliver exceptional healthcare with cutting-edge technology.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6 pt-8">
                <div className="text-center transform hover:scale-105 transition-transform duration-300">
                  ...
                  <div className="text-2xl font-black text-blue-600 mb-1">AI</div>
                  <div className="text-sm text-gray-500 font-medium">Diagnostics</div>
                </div>
                <div className="text-center transform hover:scale-105 transition-transform duration-300">
