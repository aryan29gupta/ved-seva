          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-xl">
                Access your personalized health dashboard to manage appointments, view medical records, and connect with your healthcare providers seamlessly.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6 pt-8">
                <div className="text-center transform hover:scale-105 transition-transform duration-300">
                  ...
                  <div className="text-sm text-gray-500 font-medium">Booking</div>
                </div>
                <div className="text-center transform hover:scale-105 transition-transform duration-300">
                  ...
                  <div className="text-2xl font-black text-purple-600 mb-1">Live</div>
                  <div className="text-sm text-gray-500 font-medium">Tracking</div>
                </div>
                <div className="text-center transform hover:scale-105 transition-transform duration-300">
                  ...
                  <div className="text-2xl font-black text-green-600 mb-1">Fast</div>
                  <div className="text-sm text-gray-500 font-medium">Response</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-gray-100 p-8 md:p-12 transform hover:scale-105 transition-all duration-300">
                ...
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-3xl font-black text-gray-900 mb-2">Patient Login</h2>
